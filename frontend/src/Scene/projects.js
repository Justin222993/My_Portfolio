  ...
  const handlePointerUp = (e) => {
    if (draggingIndex !== null) {
      ...
      if (
        ...
        window.open(`/project/${projects[draggingIndex].id}`, '_blank');
      }
    }
              ...
              return (
                ...
                >
                  <img
                    ...
                    alt={project.title}
                    style={{ marginBottom: '10px', borderRadius: '10px', pointerEvents: 'none', maxWidth: '400px', maxHeight: '400px'}}
                  />
            ...
            >
              ...
              {projects.map((project) => (
                <div key={project.id} className="project">
                  ...
                  >
                    {editingProject && editingProject.id === project.id ? 'Hide Form' : 'Update'}
                  </button>
